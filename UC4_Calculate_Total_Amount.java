...
public class UC4_Calculate_Total_Amount {

	public static void main(String[] args) {
		int stake_of_Gambler = 100;
        int bet_for_Game = 1;
        int Stake_after_20_Days=0;
        int count = 1;
        int win = 0;
		int loss = 0;
